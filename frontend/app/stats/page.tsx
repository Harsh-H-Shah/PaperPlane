    ...
    <div className="flex min-h-screen bg-[var(--valo-darker)]">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <main className="flex-1 p-4 sm:p-6 md:p-8 overflow-auto">
          ...
          <header className="glass-card p-4 sm:p-6 mb-6 sm:mb-8" data-gsap="fade-up">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              <div className="pl-10 md:pl-0">
                ...
                <h1 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold tracking-wider vibrant-text inline-block">
                  CAREER STATS
                </h1>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:flex lg:items-center gap-4 sm:gap-6 lg:gap-8">
                {/* Streak */}
                <div className="text-left lg:text-right group cursor-default">
                  <div className="font-display text-xl sm:text-2xl lg:text-3xl font-bold text-[var(--valo-cyan)] flex items-center gap-2 group-hover:drop-shadow-[0_0_12px_rgba(0,217,255,0.5)] transition-all">
                  ...
                  <div className="text-[10px] sm:text-xs text-[var(--valo-text-dim)] tracking-wider">STREAK</div>
                </div>

                {/* Total XP */}
                <div className="text-left lg:text-right group cursor-default">
                  <div className="font-display text-xl sm:text-2xl lg:text-3xl font-bold text-[var(--valo-green)] flex items-center gap-2 group-hover:drop-shadow-[0_0_12px_rgba(0,255,163,0.5)] transition-all">
                ...
                {/* Level */}
                <div className="text-left lg:text-right group cursor-default">
                  <div className="font-display text-xl sm:text-2xl lg:text-3xl font-bold text-[var(--valo-yellow)] flex items-center gap-2 group-hover:drop-shadow-[0_0_12px_rgba(255,229,0,0.5)] transition-all">
                ...
                {/* Today */}
                <div className="text-left lg:text-right group cursor-default">
                  <div className="font-display text-xl sm:text-2xl lg:text-3xl font-bold text-[var(--valo-red)] flex items-center gap-2 group-hover:drop-shadow-[0_0_12px_rgba(255,70,85,0.5)] transition-all">
            ...
            <>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6" data-gsap="stagger">
                <div className="gradient-card p-5 text-center stat-card-glow cursor-pointer group" data-color="cyan">
                  ...
                  <div className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-[var(--valo-text)] mb-1 group-hover:text-[var(--valo-cyan)] transition-colors group-hover:drop-shadow-[0_0_15px_rgba(0,217,255,0.4)]">
                    {stats?.total || 0}
                  </div>
                ...
                <div className="gradient-card p-5 text-center stat-card-glow cursor-pointer group" data-color="green">
                  ...
                  <div className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-[var(--valo-green)] mb-1 group-hover:drop-shadow-[0_0_15px_rgba(0,255,163,0.4)]">
                    {stats?.applied || 0}
                  </div>
                ...
                <div className="gradient-card p-5 text-center stat-card-glow cursor-pointer group" data-color="yellow">
                  ...
                  <div className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-[var(--valo-yellow)] mb-1 group-hover:drop-shadow-[0_0_15px_rgba(255,229,0,0.4)]">
                    {stats?.pending || 0}
                  </div>
                ...
                <div className="gradient-card p-5 text-center stat-card-glow cursor-pointer group" data-color="red">
                  ...
                  <div className="font-display text-2xl sm:text-3xl md:text-4xl font-bold text-[var(--valo-red)] mb-1 group-hover:drop-shadow-[0_0_15px_rgba(255,70,85,0.4)]">
                    {stats?.failed || 0}
                  </div>
              ...
              {/* Streak & Daily Stats */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-6" data-gsap="stagger">
                <div className="gradient-card p-6 text-center cursor-pointer group">
                  ...
                  <div className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--valo-cyan)] mb-2 group-hover:drop-shadow-[0_0_20px_rgba(0,217,255,0.4)] transition-all">
                ...
                <div className="gradient-card p-6 text-center cursor-pointer group">
                  ...
                  <div className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-[var(--valo-green)] mb-2 group-hover:drop-shadow-[0_0_20px_rgba(0,255,163,0.4)] transition-all">
