export default function Footer() {
  return (
    <footer className="border-t border-[var(--valo-gray-light)] bg-[var(--valo-darker)]/80 backdrop-blur-md px-4 sm:px-6 py-4 mt-auto relative">
      {/* Animated accent line at top */}
      <div className="accent-line absolute top-0 left-0 right-0" />

      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2 text-xs text-[var(--valo-text-dim)]">
        <div>
